...
function TradeForm() {
  ...
  useEffect(() => {
    FetchAPI()
    if(!id) {
      setAction('Ajouter Nouveau Échange')
    }else{
      setAction('Modifier Échange')
    }
  },[])
  ...
  const handleSubmit = async (e) => {
    ...
    if(!client || !escale || !designation || !tonnageTotal || !paysDepart || !paysArrivee || !dateEntree || !dateSortie || !heureEntree || !heureSortie || !prixService || !avions || !type ) {
      ...
      if(!id){
        ...
        await axios.put(`${API}/trades/update/${id}`, {
          client: client,
          escale : escale,
          designation :designation ,
          tonnageTotal : tonnageTotal,
  ...
  return (
    <div>
      <h2 className="page-header">Trade Form</h2>
      <div className="row">
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        label="Tonnage Total"
                        variant="filled"
                        onChange={(e) =>setTonnageTotal(e.target.value) }
                      />
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <FormControl fullWidth variant="filled" required>
                        <InputLabel id="demo-simple-select-label">Pays Départ</InputLabel>
                        <Select
                    ...
                    <Grid item xs={6}>
                      <FormControl fullWidth variant="filled" required>
                        <InputLabel id="demo-simple-select-label">Pays Arrivée</InputLabel>
                        <Select
                          labelId="demo-simple-select-label"
                          id="demo-simple-select"
                          label="Country"
